...
//        this.setResult(RESULT_OK, intent);
    ...
    Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            Log.e(TAG, "onPreviewFrame: width"+w+",height"+h);
    ...
    public void cropBitmapAndRecognize(Bitmap originalBitmap) {
        ...
        int width = metric.widthPixels;  // 屏幕宽度（像素）
        int height = metric.heightPixels;  // 屏幕高度（像素）
        Log.e(TAG, "cropBitmapAndRecognize: width"+width+",height"+height);
        ...
        Log.e(TAG, "cropBitmapAndRecognize: rectWidth"+rectWidth+",rectHight"+rectHight);
